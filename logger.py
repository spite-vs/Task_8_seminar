    ...
    if number_file == 1:  # Можно сделать нумерацию внутри файла
        ...
        if num_prop == 1:
            data_second = data_second[:number_journal] + [
                f'{name_data()};{data_temp[1]};{data_temp[2]};{data_temp[3]}'] + data_second[number_journal + 1:]
        elif num_prop == 2:
            data_second = data_second[:number_journal] + [
                f'{data_temp[0]};{surname_data()};{data_temp[2]};{data_temp[3]}'] + data_second[number_journal + 1:]
        elif num_prop == 3:
            data_second = data_second[:number_journal] + [
                f'{data_temp[0]};{data_temp[1]};{phone_data()};{data_temp[3]}'] + data_second[number_journal + 1:]
        elif num_prop == 4:
            data_second = data_second[:number_journal] + [
                f'{data_temp[0]};{data_temp[1]};{data_temp[2]};{address_data()}'] + data_second[number_journal + 1:]
        elif num_prop == 5:
            data_second = data_second[:number_journal] + [
                f'{name_data()};{surname_data()};{phone_data()};{address_data()}'] + data_second[number_journal + 1:]
    ...
    if number_file == 1:  # Можно сделать нумерацию внутри файла
        ...
        if num_prop == 1:
            data_second = data_second[:number_journal-1] + [
                f'{""};{data_temp[1]};{data_temp[2]};{data_temp[3]}'] + data_second[number_journal:]
        elif num_prop == 2:
            data_second = data_second[:number_journal-1] + [
